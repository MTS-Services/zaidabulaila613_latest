...
import { ChevronLeft, Heart, ShoppingBag, CreditCard, Truck } from "lucide-react"
                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between">
                        <div className="text-left">
                          <h3 className="font-medium">
                            <Link href={`/products/${item.id}`} className="hover:text-rose-500">
                              {item.name}
                            </Link>
                          </h3>
                        ...
                        <div className="text-right mt-1 sm:mt-0">
                          ...
                          {item.originalPrice && (
                            <div className="text-sm text-slate-500 line-through">${item.originalPrice.toFixed(2)}</div>
                          )}
                        </div>
                      </div>
