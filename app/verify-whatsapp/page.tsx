      ...
      <div className='max-w-md w-full'>
            ...
            <div className='space-y-6'>
              ...
              <div className='flex flex-col space-y-3 pt-4 border-t border-gray-100'>
                ...
                >
                  <div className='flex items-center justify-center space-x-2'>
                    <svg className='h-4 w-4' fill='currentColor' viewBox='0 0 20 20'>
                      <path fillRule='evenodd' d='M7.707 14.707a1 1 0 01-1.414 0L2.586 11H4a7 7 0 017-7h2a1 1 0 010 2h-2a5 5 0 00-5 5v.586l3.707-3.707a1 1 0 011.414 1.414l-5 5z' clipRule='evenodd' />
                    </svg>
        ...
        <div className='text-center mt-6'>
          <p className='text-xs text-gray-500'>
            By verifying your number, you agree to receive WhatsApp notifications for order updates
          </p>
        </div>
      </div>
    </div>
