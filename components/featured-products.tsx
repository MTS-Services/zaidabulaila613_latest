...
export default function FeaturedProducts() {
  ...
  const filteredProducts = activeTag === "All" ? featuredProducts : featuredProducts.filter((product) => product.type === activeTag)
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mt-8 relative">
          <div
            ...
            className="flex overflow-x-auto scrollbar-hide pb-4 space-x-4 -mx-4 px-4 relative touch-pan-x cursor-grab"
          ...
          >
            {filterTags.map((tag) => (
              <Button
                ...
                className={`flex-shrink-0 rounded-md ${activeTag === tag ? "bg-gold hover:bg-gold/90" : ""}`}
            ...
            <div key={index} className="group relative">
              ...
              <Link href={`/products/${product.id}`} className="block">
                <div className="mt-3 space-y-1">
                  ...
                  {/* Total Sales */}
                  <p className="text-xs text-slate-500">{product.totalSales} sold</p>
                </div>
              </Link>
