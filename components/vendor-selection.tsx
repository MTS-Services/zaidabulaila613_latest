...
export default function VendorSelection() {
  ...
  const scrollTo = useCallback((index: number) => desktopRow1Api && desktopRow1Api.scrollTo(index), [desktopRow1Api]) // Updated desktopEmblaApi
        ...
        <div className="lg:hidden mt-8">
          ...
          <div className="overflow-hidden" ref={mobileRow2Ref}>
            <div className="flex">
              ...
              {[...vendors.slice(4), ...vendors.slice(0, 4)].map((vendor, index) => (
                <div
    ...
    >
      <div className="relative h-full">
        ...
        <div className="p-3 flex flex-col items-start text-left h-full relative z-10">
          ...
          <div className="text-[10px] text-white/90 line-clamp-3 mb-1">{vendor.description}</div>
          <div className="mt-auto">
            <AnimatedButton
              text="View Collection"
              href={`/vendors/${vendor.slug}`}
