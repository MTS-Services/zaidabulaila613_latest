  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      ...
      <div className='relative h-64 md:h-80'>
        <Image
          src={
            'https://images.unsplash.com/photo-1594612076394-2a31c2e4c726?q=80&w=1000&auto=format&fit=crop'
          }
          alt={catName || ''}
          fill
      ...
      <ProductList
        categoryId={cat.id}
        searchPlaceHolder={`Search in ${catName}`}
      />
    </div>
  );
}
...
const categories = [
  ...
  },
  {
    ...
    slug: 'prom',
    image:
      'https://images.unsplash.com/photo-1562137369-1a1a0bc66744?q=80&w=1000&auto=format&fit=crop',
  },
  {
    name: 'BRIDAL',
    slug: 'bridal',
  ...
  },
  {
    ...
    slug: 'maternity',
    image:
      'https://images.unsplash.com/photo-1556139954-ec19cce61d61?q=80&w=1000&auto=format&fit=crop',
  },
  {
    name: 'PLUS SIZE',
    slug: 'plus-size',
...
const allProducts = [
  ...
  },
  {
    ...
    price: '1499',
    image:
      'https://images.unsplash.com/photo-1550151103-401cbd2a6614?q=80&w=1000&auto=format&fit=crop',
    vendor: {
      name: 'Elegance',
      slug: 'elegance',
    },
  },
  {
    ...
    price: '349',
    image:
      'https://images.unsplash.com/photo-1525257831700-9e2e6b3e5ec3?q=80&w=1000&auto=format&fit=crop',
    vendor: {
      name: 'Elegance',
      slug: 'elegance',
    },
  },
  {
    ...
    price: '999',
    image:
      'https://images.unsplash.com/photo-1583804555142-aaa6bf4575b9?q=80&w=1000&auto=format&fit=crop',
    vendor: {
      name: 'Elegance',
      slug: 'elegance',
    },
  ...
  },
  {
    ...
    price: '1199',
    image:
      'https://images.unsplash.com/photo-1595158232095-01d2a6c0f841?q=80&w=1000&auto=format&fit=crop',
    vendor: {
      name: 'Bella Boutique',
      slug: 'bella-boutique',
    },
  ...
  },
  {
    ...
    price: '799',
    image:
      'https://images.unsplash.com/photo-1559673950-46c63c31bc57?q=80&w=1000&auto=format&fit=crop',
    vendor: {
      name: 'Elegance',
      slug: 'elegance',
    },
