                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                      <div className='md:col-span-2'>
                        <h4 className='text-md font-medium text-gray-900 mb-3'>
                          {t('dashboard.order.orderitem')}
                        </h4>
                        <div className='space-y-4'>
                          {order.items.map((item: any, index: number) => (
                            <div
                              key={index}
                              className='flex items-start space-x-4 p-3 border rounded-lg justify-between'
                            >
                        ...
                        <div>
                          ...
                          <div className='space-y-2'>
                            ...
                            <div className='flex justify-between flex-col sm:flex-row gap-1'>
                              ...
                              <span className='text-sm font-medium text-gray-900'>
                                {order.isPaid
                                  ? t('dashboard.order.paid')
                                  : t('dashboard.order.pending')}
                              </span>
                            </div>
                            <div className='flex justify-between flex-col sm:flex-row gap-1'>
                              <span className='text-sm text-gray-500'>
                                {t('dashboard.order.address')}
                              </span>
