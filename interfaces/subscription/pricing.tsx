                    ...
                    <div className="inline-flex rounded-md shadow-sm">
                        {durations.map((duration) => (
                            ...
                            >
                                ...
                                {duration === "monthly" ? t('dashboard.subcription.monthly') :
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-4 flex items-center justify-center">
                                                ...
                                                <span className="text-xl font-medium text-gray-500">
                                                    ...
                                                    {selectedDuration === "monthly" ? t('dashboard.subcription.monthly') :
                                                        selectedDuration === "yearly" ? t('dashboard.subcription.yearly') :
                                                            selectedDuration === "quarterly" ? t('dashboard.subcription.quarterly') :
                                                                null}
                                                </span>
                                            </div>
                                            {savings > 0 && (
