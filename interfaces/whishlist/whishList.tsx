                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      <p className="font-bold">
                        ${typeof item.price === t('wishlist.number') ? item.price.toFixed(2) : item.price}
                      </p>
                      {item.originalPrice && (
                        <p className="text-sm text-slate-500 line-through">
                          ${typeof item.originalPrice === t('wishlist.number') ? item.originalPrice.toFixed(2) : item.originalPrice}
                        </p>
                      )}
                    </div>
