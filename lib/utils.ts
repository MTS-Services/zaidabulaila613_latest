...
export const enCurrencies = [
  ...
  { id: 'ils', code: "ILS", countryCode: "PS", name: "Shekel", symbol: "Shekel", },
...
export const arCurrencies = [
  ...
  { id: 'ils', code: "ILS", countryCode: "PS", name: "فلسطين", symbol: "دولار", },
  { id: 'kwd', code: "KWD", countryCode: "KW", name: "كويت", symbol: "د.ك" },
